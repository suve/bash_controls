bash_controls
========================================
Aimed at notebook users, bash_controls is a set of bash scripts
allowing to control various pieces of the machine. They can be
used from the commandline, but are even more helpfun when bound
